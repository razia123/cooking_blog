...
<head>
    ...
    <!-- Bootstrap Css -->
    <link id="style" href="{{ asset('/back-end/libs/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">

    <!-- Style Css -->
    <link href="{{ asset('/back-end/css/styles.min.css') }}" rel="stylesheet">

    <!-- Icons Css -->
    <link href="{{ asset('/back-end/css/icons.css') }}" rel="stylesheet">

    <!-- Node Waves Css -->
    <link href="{{ asset('/back-end/libs/node-waves/waves.min.css') }}" rel="stylesheet">

    <!-- Simplebar Css -->
    <link href="{{ asset('/back-end/libs/simplebar/simplebar.min.css') }}" rel="stylesheet">

    <!-- Color Picker Css -->
    <link rel="stylesheet" href="{{ asset('/back-end/libs/flatpickr/flatpickr.min.css') }}">
    <link rel="stylesheet" href="{{ asset('/back-end/libs/@simonwep/pickr/themes/nano.min.css') }}">

    <!-- Quill editor css -->
    <link rel="stylesheet" href="{{ asset('/back-end/libs/quill/quill.snow.css') }}">

    <!-- Choices Css -->
    <link rel="stylesheet" href="{{ asset('/back-end/libs/choices.js/public/assets/styles/choices.min.css') }}">
...
<body>
    ...
    <!-- Bootstrap JS -->
    <script src="../back-end/libs/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Defaultmenu JS -->
    <script src="../back-end/js/defaultmenu.min.js"></script>

    <!-- Node Waves JS-->
    <script src="../back-end/libs/node-waves/waves.min.js"></script>

    <!-- Sticky JS -->
    <script src="../back-end/js/sticky.js"></script>

    <!-- Simplebar JS -->
    <script src="../back-end/libs/simplebar/simplebar.min.js"></script>
    ...
    <!-- JSVector Maps JS -->
    <script src="../back-end/libs/jsvectormap/js/jsvectormap.min.js"></script>

    <!-- JSVector Maps MapsJS -->
    <script src="../back-end/libs/jsvectormap/maps/world-merc.js"></script>

    <!-- Apex Charts JS -->
    <script src="../back-end/libs/apexcharts/apexcharts.min.js"></script>

    <!-- Chartjs Chart JS -->
    <script src="../back-end/libs/chart.js/chart.min.js"></script>

    <!-- CRM-Dashboard -->
    <script src="../back-end/js/crm-dashboard.js"></script>


    <!-- Custom-Switcher JS -->
    <script src="../back-end/js/custom-switcher.min.js"></script>
